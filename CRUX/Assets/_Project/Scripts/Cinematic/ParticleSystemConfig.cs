...
namespace Crux.Cinematic
{
    ...
    public static class ParticleSystemConfig
    {
        ...
        // ---------- 5. CoreBlast (중앙 폭발 불덩이) ----------

        /// <summary>
        /// CoreBlast — 한 번 번쩍 큰 중앙 불덩이.
        /// Burst 1, Shape 비활성, Lifetime 0.2, Size 3→0 빠른 축소.
        /// </summary>
        public static void ConfigureCoreBlast(ParticleSystem ps)
        {
            if (ps == null) return;
            ps.Stop();
            ps.Clear();
            ...
            main.startSpeed = 0f;
            main.startSize = 3f;
            main.startColor = new Color(1.5f, 1f, 0.5f, 1f);
            main.simulationSpace = ParticleSystemSimulationSpace.World;
            main.maxParticles = 3;
        ...
        /// <summary>
        /// Shockwave — Circle edge 방출로 링 형태 외향 확산.
        /// Burst 25, Speed 15~25, Lifetime 0.3, Size 유지.
        /// </summary>
        public static void ConfigureShockwave(ParticleSystem ps)
        {
            if (ps == null) return;
            ps.Stop();
            ps.Clear();
            ...
            // Circle 가장자리에서 방출 → 링 형태
            var shape = ps.shape;
            shape.enabled = true;
            shape.shapeType = ParticleSystemShapeType.Circle;
            shape.radius = 0.1f;
            shape.radiusThickness = 0f;  // 가장자리만
